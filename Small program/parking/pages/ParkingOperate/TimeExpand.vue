<template>
	<view>
		...
		<navBar left-icon="back" background-color="#dbf3e5" :shadow='false' @clickLeft='goback' title="停车续时"></navBar>
		<view class="top">
			<view class="avator uni-flex uni-column">
				<view class="flex-item flex-item-V" style="margin-bottom: 20upx; font-size: x-large;">当前停放车辆</view>
		...
		<view>
			...
			<cBtn @cctap="timeExpand" :isdisable="current == '无'" width='90%' color="#000" fontsize="45rpx" :bgcolor='current == "无" ? bgcolor2 : bgcolor1 '>
				确认
			</cBtn>
		</view>
	</view>
